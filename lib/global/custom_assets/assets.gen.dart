...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/logo_svg.svg
  SvgGenImage get logoSvg => const SvgGenImage('assets/icons/logo_svg.svg');
...
class $AssetsPayGen {
  ...
  /// File path: assets/pay/apple_pay.json
  String get applePay => 'assets/pay/apple_pay.json';

  /// File path: assets/pay/google_pay.json
  String get googlePay => 'assets/pay/google_pay.json';
...
class Assets {
  ...
  static const $AssetsPayGen pay = $AssetsPayGen();
}
